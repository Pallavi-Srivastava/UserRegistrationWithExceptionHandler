...
public class ValidateUserRegistrationTest {
	...
	public void testPassword3WhenWeUsemin8CharWithAtleastOneUpperCaseAndOneNumericValue_thenAssertionHappy() {
		boolean result = obj.isValidPasswordAccToRule3("asWsq@D6");
		assertEquals(true, result);
		System.out.println("Successfully Passed TestCase");
	}
	...
	public void testPassword3WhenWeUseLessThan8CharWithoutOneUpperCaseAndOneNumericValue_thenAssertionSad() {
		boolean result = obj.isValidPasswordAccToRule3("asdgfbv@");
		assertEquals(true, result);
		System.out.println("Fail To Pass TestCase");
	}
	...
	public void testPassword4WhenWeUsemin8CharWithAtleastOneUpperCaseOneNumericValueAndOneSpecialChar_thenAssertionHappy() {
		boolean result = obj.isValidPasswordAccToRule4("AsWqsD6!");
		assertEquals(true, result);
		System.out.println("Successfully Passed TestCase");
	}
	...
	public void testPassword4WhenWeUseLessThan8CharWithoutOneUpperCaseOneNumericValueAndOneSpecialChar_thenAssertionSad() {
		boolean result = obj.isValidPasswordAccToRule4("AsvfSA4x");
		assertEquals(true, result);
		System.out.println("Fail To Pass TestCase");
	}

	// Checking the validity of sample email
	@Test
	public void testEmailWhenWePassCorrectFormat_thenAssertionHappy() {
		boolean result = obj.isValidPasswordAccToRule4("ram853@gmail.com");
		assertEquals(true, result);
		System.out.println("Successfully Passed TestCase");
	}

	@Test
	public void testEmailWhenTldStartWithdot_thenAssertionSad() {
		boolean result = obj.isValidPasswordAccToRule4("abc@.com.my");
		assertEquals(true, result);
		System.out.println("Fail To Pass TestCase");
	}

	@Test
	public void testEmailWhenEmailFirstCharStartWithDot_thenAssertionSad() {
		boolean result = obj.isValidPasswordAccToRule4(".ac@abc.com");
		assertEquals(true, result);
		System.out.println("Fail To Pass TestCase");
	}

	@Test
	public void testEmailWhenWeUseMultipleTld_thenAssertionSad() {
		boolean result = obj.isValidPasswordAccToRule4("abc@gmail.com.aa.au");
		assertEquals(true, result);
		System.out.println("Fail To Pass TestCase");
	}
}
